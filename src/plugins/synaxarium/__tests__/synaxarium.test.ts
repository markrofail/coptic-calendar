...
describe('Synaxarium Plugin', () => {
    it.each([
        { month: 1, day: 1, expected: 'Feast of El-Nayrouz (Beginning of the Blessed Coptic Year).', title: 'Nayrouz' },
        { month: 4, day: 29, expected: 'The Feast of the Nativity of Our Lord Jesus Christ (Christmas).', title: 'Nativity' },
        { month: 5, day: 11, expected: 'The Holy Theophany of Our Lord, God and Savior, Jesus Christ (Baptism of the Lord christ).', title: 'Epiphany' },
        { month: 8, day: 23, expected: 'The Martyrdom of St. George Prince of the Martyrs.', title: 'St. George' },
        { month: 9, day: 7, expected: 'The Departure of St. Athanasius the Apostolic the 20th. Pope of Alexandria.', title: 'St. Athanasius' },
